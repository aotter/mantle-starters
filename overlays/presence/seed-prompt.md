...
Keep the first screen useful without requiring images. The result should
fit the `page` Schema with one `home` page. Keep the homepage as an
ordered `sections` array using these section types when they are useful:
