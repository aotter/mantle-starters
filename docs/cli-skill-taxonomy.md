...
`scripts/.mantle-provision.mjs`, but the shared `_common/scripts/provision.mjs`
owns the user-facing lifecycle and shared context for every archetype. The
default happy path should not
