...
This repo holds the public starter scaffolds + the `create-mantle` scaffolder for the [mantle](https://github.com/aotter/mantle) project. Most consumers never see this repo directly — they run the scaffolder via `npx @aotter/create-mantle@alpha`.
...
The `create-mantle` scaffolder is published to npm under the `@aotter/create-mantle` package. Consumers run it via:
