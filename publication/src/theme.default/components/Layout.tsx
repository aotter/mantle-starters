 ...
 *
 * Override flow: the consumer's `mantleConfig.ts` calls
 ...
 * once at consumer boot from `mantleConfig.ts`; returns a Layout that
 ...
 *  call `createLayoutFactory({...})` from `mantleConfig.ts`. */
